...
def _read_max_session_resolve_concurrent() -> int:
    ...
    value does not regress to a blocked or unbounded state. The
    upper bound (64) is a generous but finite safety net against
    a typo like ``=999999`` bypassing the bounded semaphore
    entirely; the deeper per-read cost is tracked in #7310."""
